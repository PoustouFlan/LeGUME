...
let
  packages = p: with p; (
    let
      ...
      tortoise-orm = buildPythonPackage rec {
          pname = "tortoise-orm";
          version = "0.19.3";
          format = "wheel";
    ...
    [
      ...
      (
        buildPythonPackage rec {
          ...
          src = fetchPypi {
            inherit pname version;
            sha256 = "sha256-3YA+hdBENJgghPR4jBpREfdheCgOtkhzJXNmKg41Uhg=";
          };
          doCheck = false;
          nativeBuildInputs = [ poetry-core ];
          propagatedBuildInputs = [ poetry-core tortoise-orm tomlkit click ptpython ];
          postFixup = ''
            rm $out/lib/${python.libPrefix}/site-packages/{README.md,CHANGELOG.md}
          '';
        }
